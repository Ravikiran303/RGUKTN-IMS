...
public class PendingTech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_tech);
...
//        });
    ...
    private void uploadTechPlum(){
        ...
        if (!type.equals("--CHOOSE TYPE--") && !pos.equals("--Select Position--")) {
            ...
            try {
                Intent intent = new Intent(PendingTech.this,Tech_plum.class);
                startActivity(intent);
                //Tech_plum tech_plum = new Tech_plum();
                Toast.makeText(PendingTech.this, "Attended Successfully..", Toast.LENGTH_SHORT).show();
                finish();
            }catch (Error e){
                e.printStackTrace();
            }
