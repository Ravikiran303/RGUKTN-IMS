...
public class Upload_Elect extends AppCompatActivity {
    ...
    UploadImageElect uploadImageElect;
...
//    private String Room ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__elect);

        databaseElect = FirebaseDatabase.getInstance().getReference("ElectricalWork");
        Storage = FirebaseStorage.getInstance().getReference("ElectricalWork");
...
//        final String BlockName = mBlockName.getSelectedItem().toString().toUpperCase();
//        final String BlockNo = mBlockNo.getSelectedItem().toString().toUpperCase();
        final String Floor = mFloor.getSelectedItem().toString().toUpperCase();
        ...
        if( !ComponentName.equals("--Select Component--") && uri != null && !Floor.equals("--Select Floor--")){
            ...
            Log.d("Bytes - ", String.valueOf(fileInBytes));
            ...
            mUploadTask = imagePath.putBytes(fileInBytes).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Uri D_uri = taskSnapshot.getDownloadUrl();
                    String id = databaseElect.push().getKey();

                    uploadImageElect= new UploadImageElect(id,Service, D_uri.toString(), ComponentName.toUpperCase(), Block, Floor, Room,logmail,date);
                    databaseElect.child(id).setValue(uploadImageElect);
                    Intent intent = new Intent(Upload_Elect.this,Services.class);
                    startActivity(intent);
                    progressDialog.dismiss();
                    finish();
                    Toast.makeText(Upload_Elect.this, "Problem has been posted successfully. Status will be updated soon.", Toast.LENGTH_LONG).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Upload_Elect.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(Upload_Elect.this, "Uploading..Wait", Toast.LENGTH_SHORT).show();
                }
            });
        }else {
