...
public class PendingCar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_car);
...
//        });
    ...
    private void uploadTechCar(){
        ...
        if (!type.equals("--CHOOSE TYPE--") && !pos.equals("--Select Position--")) {
            ...
            try {
                Intent intent = new Intent(PendingCar.this,Tech_car.class);
                startActivity(intent);
                Toast.makeText(PendingCar.this, "Attended Successfully..", Toast.LENGTH_SHORT).show();
                finish();
            }catch (Error e){
                e.printStackTrace();
            }
