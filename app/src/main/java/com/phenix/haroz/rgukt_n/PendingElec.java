...
public class PendingElec extends AppCompatActivity {
    private ExpandableListView expandableListView;
    private ExpandableListAdapterEle listAdapter;
    ...
    private DatabaseReference databaseElec;
    private TechUploadPlum techUploadElec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_elec);
        databaseElec = FirebaseDatabase.getInstance().getReference("TechWork");
        ...
        repairListData();
        listAdapter = new ExpandableListAdapterEle(this, listDataHeader, listDataChild);
...
//                uploadTechElec();
//                //Toast.makeText(TechEleRepair.this, "Completed Successfully..", Toast.LENGTH_SHORT).show();
//
//            }
//        });
        ...
        btpending.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                uploadTechElec();
                //Toast.makeText(TechEleRepair.this, "Attended Successfully..", Toast.LENGTH_SHORT).show();
            }
        });

    }
    private void uploadTechElec(){
        ...
        if (!type.equals("--CHOOSE TYPE--") && !pos.equals("--Select Position--")) {
            techUploadElec = new TechUploadPlum(filter, filter1, filter2, filter3, date, status, filter4, pos, type, s,filter5);
            String id = databaseElec.push().getKey();
            databaseElec.child(id).setValue(techUploadElec);
            try {
                Intent intent = new Intent(PendingElec.this,Tech_services.class);
                startActivity(intent);
                Toast.makeText(PendingElec.this, "Attended Successfully..", Toast.LENGTH_SHORT).show();
                finish();
            }catch (Error e){
                throw e;
            }
    ...
    private void repairListData() {
        ...
        // Adding child data
        listDataHeader.add("FN");
        listDataHeader.add("LT");
        listDataHeader.add("SB");
        listDataHeader.add("PJ");
        listDataHeader.add("LR");
        ...
        listDataChild.put(listDataHeader.get(0), FN); // Header, Child data
        listDataChild.put(listDataHeader.get(1), LT);
        listDataChild.put(listDataHeader.get(2), SB);
        listDataChild.put(listDataHeader.get(3),PJ);
        listDataChild.put(listDataHeader.get(4), LR);
    }
