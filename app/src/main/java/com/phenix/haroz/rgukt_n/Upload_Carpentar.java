...
public class Upload_Carpentar extends AppCompatActivity {
    ...
    UploadImageCarpentar uploadImageCarpentar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__carpentar);


        databaseCarpentar = FirebaseDatabase.getInstance().getReference("CarpentryWork");
        Storage = FirebaseStorage.getInstance().getReference("CarpentryWork");
        ...
        if(uri!=null && !ComponentName.equals("--Select Component--") && !Floor.equals("--Select Floor--")){
            ...
            mUploadTask = imagePath.putBytes(fileInBytes).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(Upload_Carpentar.this, "Problem has been posted successfully. Status will be updated soon.", Toast.LENGTH_LONG).show();
                    String id = databaseCarpentar.push().getKey();

                    uploadImageCarpentar = new UploadImageCarpentar(id,Service, taskSnapshot.getDownloadUrl().toString(), ComponentName.toUpperCase(), Block, Floor, Room,logmail,date);
                    databaseCarpentar.child(id).setValue(uploadImageCarpentar);
                    Intent intent = new Intent(Upload_Carpentar.this,Services.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Upload_Carpentar.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(Upload_Carpentar.this, "Uploading..Wait", Toast.LENGTH_SHORT).show();
                }
            });
        }else {
