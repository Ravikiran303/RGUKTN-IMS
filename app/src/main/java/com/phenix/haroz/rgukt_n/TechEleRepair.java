...
public class TechEleRepair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_ele_repair);
...
//        });
    ...
    private void uploadTechElec(){
        ...
        if (!type.equals("--CHOOSE TYPE--") && !pos.equals("--Select Position--")) {
            ...
            try {
                Intent intent = new Intent(TechEleRepair.this,Tech_services.class);
